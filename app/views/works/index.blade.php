...
<section class='container greyBackground'>
	<h3>Esto es solo una parte de lo que PAM puede ofrecete, te invitamos a conocernos:</h3>
<p>Puedes utilizar nuestra sección {{ HTML::link(URL::to('about-us'), 'nosotros') }} o {{ HTML::link(URL::to('services'), 'servicios') }} para conocer PAM un poco más. También puedes comunicarte telefónicamente  con nosotros para que podamos ayudarte.<br><br>
